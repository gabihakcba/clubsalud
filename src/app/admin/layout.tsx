              ...
              <ul className='space-y-2 font-medium'>
                <li>
                  ...
                  >
                    ...
                    <span className='ms-3'>Cobros</span>
                  </Link>
                </li>
                <li>
                  <Link
                ...
                <HasRole required={[Permissions.ADM, Permissions.OWN]}>
                  <li>
                    <Link
                      ...
                      className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${pathname === '/admin/employees' ? 'bg-gray-500' : ''}`}
                    >
                      <svg
                        width='1.5rem'
                        height='1.5rem'
