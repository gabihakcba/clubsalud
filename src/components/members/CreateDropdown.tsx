...
import { CreateMember, Member, MemberSate, QueriesResponse } from "utils/types"
...
const create = async (data: FieldValues, setIsOpen: Function, setMembers: Function, setPages: Function): Promise<void> => {
  const id = await idAccount(data.accountName)
  if (id > 0) {
    const newMember: CreateMember = formToMember(data, id)
    const response: QueriesResponse = await createMember(newMember)
    if (response.status === 200) {
      setIsOpen((prev: boolean) => !prev)
      setMembers((prev: Array<Member>) => {
...
export function CreateDropdown({ setMembers, setPages }) {
  ...
  return (
    <div className={'flex flex-col w-full mb-5 md:m-2 md:w-max md:mr-5'}>
      ...
      }
      {
        isOpen &&
        <form
          onSubmit={handleSubmit((data) => create(data, setIsOpen, setMembers, setPages))}
          ...
          <div className="mb-2">
            <label className="block text-gray-700 text-base font-bold mb-2" htmlFor="lastName">
              Apellido
            </label>
            <input
              {...register('lastName', {
            ...
            {
              errors?.lastName &&
              <span className="inputError">{errors.lastName.message as string}</span>
            }
          </div>
          <div className="mb-2">
            <label className="block text-gray-700 text-base font-bold mb-2" htmlFor="dni">
              DNI
            </label>
            <input
              {...register('dni', {
          ...
          <div className="mb-2">
            <label className="block text-gray-700 text-base font-bold mb-2" htmlFor="cuit">
              CUIT
            </label>
            <input
              {...register('cuit')}
          ...
          <div className="mb-2">
            <label className="block text-gray-700 text-base font-bold mb-2" htmlFor="phoneNumber">
              Número de teléfono
            </label>
            <input
            ...
            {
              errors?.phoneNumber &&
              <span className="inputError">{errors.phoneNumber.message as string}</span>
            }
          </div>
          <div className="mb-2">
          ...
          <div className="mb-2">
            <label className="block text-gray-700 text-base font-bold mb-2" htmlFor="inscriptionDate">
            ...
            </input>
            {
              ...
              <span className="inputError">{errors.inscriptionDate.message as string}</span>
            }
          </div>
          <div className="mb-2">
            <label className="block text-gray-700 text-base font-bold mb-2" htmlFor="derivedBy">
              Derivado por
            </label>
            <input
              {...register('derivedBy', {
            ...
            {
              errors?.derivedBy &&
              <span className="inputError">{errors.derivedBy.message as string}</span>
            }
          </div>
          <div className="mb-2">
            <label className="block text-gray-700 text-base font-bold mb-2" htmlFor="afiliateNumber">
              Número de afiliado
            </label>
            <input
            ...
            </input>
            {
              ...
              <span className="inputError">{errors.afiliateNumber.message as string}</span>
            }
          </div>
          <div className="mb-2">
            <label className="block text-gray-700 text-base font-bold mb-2" htmlFor="accountName">
              Cuenta asociada
            </label>
            <input
            ...
            {
              errors?.accountName &&
              <span className="inputError">{errors.accountName.message as string}</span>
            }
          </div>
