...
import { type Account, type CreateMember, MemberSate, type Member } from 'utils/types'
...
export default function ProfileMemberCard({ member }: { member: Member }): ReactElement {
